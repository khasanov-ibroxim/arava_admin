...
const SingleShopProductFilter = ({ setFiltrUsers }) => {
    ...
    return (
        <div className={"filterBox"} style={{display:"block"}}>
            <div className={"filterBox_panel"}>
                ...
                <div className={"filterBox_item"}>
                    <input type="text" placeholder="Product name" value={username} onChange={handleUsernameChange} />
                </div>
                <div className={"filterBox_item"}>
                    <input type="text" placeholder="Code" value={username} onChange={handleUsernameChange} />
                </div>
                <div className={"filterBox_item"}>
...
export default SingleShopProductFilter;